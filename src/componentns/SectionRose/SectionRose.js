...
function SectionRose() {
  return (
    <div id='sectionRose' className='sectionRose'>
        <h2 className='headerline headerline4'>Flowerave is a project based on TON Blockchain technology created in collaboration between the team of lead by Culture3k and Moscow based record label System (108)</h2>
