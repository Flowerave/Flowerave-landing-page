...
function SectionRose() {
  return (
    <div id='sectionRose' className='sectionRose'>
        ...
        <h2 className='body'>Flowerave is a project based on TON Blockchain technology created in collaboration between the team of lead by Culture3k and Moscow based record label System (108)</h2>
